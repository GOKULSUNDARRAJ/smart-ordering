...
public class ScanAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private static final int VIEW_TYPE_PRODUCT = 0;
    private static final int VIEW_TYPE_BUTTON = 1;

    private Context context;
    private List<Scanorder> productList;

    public ScanAdapter2(Context context, List<Scanorder> productList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_BUTTON) {
            ...
            View productView = LayoutInflater.from(context).inflate(R.layout.scan2, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder.getItemViewType() == VIEW_TYPE_PRODUCT) {
            ...
            Scanorder product = productList.get(position);
    ...
    public static class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textViewProductCountAndPrice, textViewCount;
        ImageView dec, inc;
